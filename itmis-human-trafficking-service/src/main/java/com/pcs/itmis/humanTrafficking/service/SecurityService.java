...
import com.pcs.itmis.humanTrafficking.model.ResponseWrapperClass;
import com.pcs.itmis.humanTrafficking.utils.RestTemplateConfiguration;
...
public class SecurityService {
	...
	public Organization getOrganizationOfLogInUser() throws Exception {
		...
		ResponseEntity<ResponseWrapperClass> responseEntity = restTemplate.exchange(
				SECURITY_SERVICE_URL + "organizations/by-logged-in-user", HttpMethod.GET, entity,
				ResponseWrapperClass.class);
