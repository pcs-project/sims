...
class SocialServiceRegistrationService {
  ...
  updateSocialServiceRegistration(id,data) {
    console.log("inside updateSocialServiceRegistration method of SocialServiceRegistrationService");
  ...
  deleteSocialServiceRegistration(id) {
    console.log("inside deleteSocialServiceRegistration method of SocialServiceRegistrationService");
