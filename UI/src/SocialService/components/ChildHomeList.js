...
const ChildHomeList = () => {
  ...
  const [childHomeList, setChildHomeList] = useState([]);
          ...
          return (
            <React.Fragment>
              <i
                ...
                onClick={() =>
                  history.push({
                    pathname: "/sims/child-home",
                    state: {
                      childHomeCaseId: value,
                    },
                  })
                }
              />
  ...
  useEffect(() => {
    trackPromise(
      ChildHomeCaseService.getAllList().then((response) => {
        console.log("response.data", response.data);
        setChildHomeList(response.data);
      })
    );
  }, []);
  return (
