...
const OldAgeHomeList = () => {
  ...
  const [oldAgeHomeList, setOldAgeHomeList] = useState([]);
          ...
          return (
            <React.Fragment>
              <i
                ...
                onClick={() =>
                  history.push({
                    pathname: "/sims/old-age-home",
                    state: {
                      oldAgeHomeCaseId: value,
                    },
                  })
                }
              />
  ...
  useEffect(() => {
    trackPromise(
      OldAgeHomeService.getAllList().then((response) => {
        console.log("response.data", response.data);
        setOldAgeHomeList(response.data);
      })
    );
  }, []);
  return (
