...
const ShelterHomeList = () => {
  const { t } = useTranslation();
  const [shelterHomeList, setShelterHomeList] = useState([]);
          ...
          return (
            <React.Fragment>
              <i
                ...
                onClick={() =>
                  history.push({
                    pathname: "/sims/shelter-home",
                    state: {
                      shelterHomeCaseId: value,
                    },
                  })
                }
              />
  ...
  useEffect(() => {
    trackPromise(
      ShelterHomeCaseService.getAllList().then((response) => {
        console.log("response.data", response.data);
        setShelterHomeList(response.data);
      })
    );
  }, []);
  return (
...
export default ShelterHomeList;
