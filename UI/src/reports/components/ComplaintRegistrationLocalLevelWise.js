...
const ComplaintRegistrationLocalLevelWise = () => {
  ...
  useEffect(() => {
    ...
    trackPromise(
      ReportService.getComplaintRegLocalWiseData(districtId).then((response) => {
...
export default ComplaintRegistrationLocalLevelWise;
