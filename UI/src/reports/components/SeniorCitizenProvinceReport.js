...
const SeniorCitizenProvinceWiseReport = () => {
  ...
  useEffect(() => {
    ...
    ReportService.getSeniorCitizenProvinceData().then((response) => {
        ...
        res.data.data.forEach(provList => {
            ...
            if (provList.id == data.province_id) {
              found = true;
                provinceWiseData.push({
                  ...
                  male_senior_getting_spa: data.male_senior_getting_spa,
                  female_count: data.female_count,
                  female_senior_getting_spa: data.female_senior_getting_spa,
                  others_count: data.others_count,
                  others_senior_getting_spa: data.others_senior_getting_spa
                });
          ...
          if(found === false) {
              provinceWiseData.push({
                ...
                male_count: 0,
                male_senior_getting_spa: 0,
                female_count: 0,
                female_senior_getting_spa: 0,
                others_count: 0,
                others_senior_getting_spa: 0
              });
          };
        });
  ...
  const provinceWiseColumns = [
    ...
    {
      name: "male_senior_getting_spa",
      label: t("maleGettingSSA"),
      options: {
        customBodyRender: (value, tableMeta, updateValue) => {
          return value;
        },
    ...
    {
      name: "female_senior_getting_spa",
      label: t("femaleGettingSSA"),
      options: {
        customBodyRender: (value, tableMeta, updateValue) => {
          return value;
        },
    ...
    {
      name: "others_senior_getting_spa",
      label: t("othersGettingSSA"),
      options: {
        customBodyRender: (value, tableMeta, updateValue) => {
          return value;
        },
  ...
  const getDistrictWiseData = (provinceId) => {
    trackPromise(
      ReportService.getSeniorCitizenDistrictData(provinceId).then((response) => {
          ...
          return (
            <React.Fragment>
              <Button
                ...
                onClick={() =>
                  history.push({
                    pathname: "/sims/senior-citizen-local-level-wise",
                    state: {
                      districtId: value,
                    },
                  })
...
export default SeniorCitizenProvinceWiseReport;
