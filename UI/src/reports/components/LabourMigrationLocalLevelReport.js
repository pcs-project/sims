...
const LabourMigrationLocalLevelWiseReport = () => {
    ...
    useEffect(() => {
        ...
        trackPromise(
            ReportService.getLabourMigrationLocalWiseData(districtId).then((response) => {
...
export default LabourMigrationLocalLevelWiseReport;
