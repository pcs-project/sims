...
const SeniorCitizenLocalLevelWiseReport = () => {
    ...
    useEffect(() => {
        ...
        trackPromise(
            ReportService.getSeniorCitizenLocalWiseData(districtId).then((response) => {
...
export default SeniorCitizenLocalLevelWiseReport;
