...
const Sidebar = () => {
  ...
  const data = [
    ...
    // },
    {
      ...
      subMenu: [],
      title: "Women and Minorities",
      url: "/sims/cumulative-women-gender1",
    },
    // {
    //   hasChild: 0,
    //   icon: "pi pi-lock",
    ...
    // },
    {
      ...
      subMenu: [],
      title: "Child Home",
      url: "/sims/child-home-indicator1",
    },
    // {
    //   hasChild: 0,
    //   icon: "pi pi-lock",
    ...
    // },
    {
      ...
      subMenu: [],
      title: "Child Correction Home",
      url: "/sims/juvenial-child-home-indicator1",
    },
    // {
    //   hasChild: 0,
    //   icon: "pi pi-lock",
    ...
    // },
    {
      ...
      subMenu: [],
      title: "Old Age Home",
      url: "/sims/old-age-home-indicator1",
    },
    {
      hasChild: 1,
      icon: "pi pi-lock",
    ...
    },
    {
      ...
      subMenu: [
        ...
        // },
        {
          ...
          subMenu: [],
          title: "Shelter Home",
          url: "/sims/shelter-home-indicator1",
        },
        // {
        //   hasChild: 0,
        //   icon: "pi pi-file",
        ...
        // },
        {
          ...
          subMenu: [],
          title: "Complaint Registration",
          url: "/sims/complaint-registration1",
        },
      ],
    ...
    },
    {
      ...
      subMenu: [
        ...
        // },
        {
          ...
          subMenu: [],
          title: "Indicator",
          url: "/sims/labour-migration-indicator1",
        },
        {
          hasChild: 0,
          icon: "pi pi-file",
      ...
      <div>
        <div className="profileBox">
          <div className="circleUser">
            <i className="pi pi-user" style={{ fontSize: "3em", color: "#FFFFFF" }}></i>
          </div>
