        ...
        trackPromise(
            ...
            ReportService.getComplaintRegistrationCumulativeData().then((response) => {
                if (response.data.length > 0) {
                    ...
                    console.log("complaint reg ", response.data);
                    let provList = [], complaintRegData = [];
                        ...
                        res.data.data.forEach(provList => {
                            ...
                            response.data.forEach(data => {
                                if (provList.id == data.province_id) {
                                    found = true;
                                    complaintRegData.push({
                                        province_id: data.province_id,
                                        province_desc_eng: data.province_desc_eng,
                                        province_desc_nep: data.province_desc_nep,
                                        cr_under47part1: data.cr_under47part1
                                    });
                                    console.log("complaint reg 1", complaintRegData);
                                    return;
                                }
                            })
                            if (found === false) {
                                ...
                                console.log("complaint reg 2", complaintRegData);
                            }
                        });

                        let crData = {
                            labels: [
                                complaintRegData[0].province_desc_eng,
                                complaintRegData[1].province_desc_eng,
                                complaintRegData[2].province_desc_eng,
                                complaintRegData[3].province_desc_eng,
                                complaintRegData[4].province_desc_eng,
                                complaintRegData[5].province_desc_eng,
                                complaintRegData[6].province_desc_eng
                            ],
                            datasets: [
                                {
                                    backgroundColor: '#FF6384',
                                    ...
                                    label: t("totalNo"),
                                    data: [
                                        complaintRegData[0].cr_under47part1,
                                        complaintRegData[1].cr_under47part1,
                                        complaintRegData[2].cr_under47part1,
                                        complaintRegData[3].cr_under47part1,
                                        complaintRegData[4].cr_under47part1,
                                        complaintRegData[5].cr_under47part1,
                                        complaintRegData[6].cr_under47part1
                                    ],
                                }
                            ],
                        }
            ...
            <div className="p-grid">
                ...
                <div className="p-grid p-col-10 p30 content card">
                    ...
                    <div className="p-col-12" style={{ float: 'left' }}>
                        ...
                        <div className="p-col-4" style={{ float: 'left' }}>
                            <Card className="margin-0">
