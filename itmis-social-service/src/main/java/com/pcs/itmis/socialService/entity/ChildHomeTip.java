...
@Entity
@Table(name = "CHILD_HOME_TIP")
@Data
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode(exclude = "childHomeCase")
public class ChildHomeTip {

  @Id
  @GeneratedValue(strategy = GenerationType.AUTO)
  private Long childHomeTipId;
  
  @OneToOne
  @MapsId
  @JsonBackReference
  @JoinColumn(name = "childHomeCaseId")
  private ChildHomeCase childHomeCase;
  ...
  public void copyTipData(ChildHomeTip nDetails) {
