...
@Entity
@Table(name = "SHELTER_HOME_TIP")
@Data
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode(exclude = "shelterHomeCase")
public class ShelterHomeTip {
  @Id
  @GeneratedValue(strategy = GenerationType.AUTO)
  private Long shelterHomeTipId;
  
  @OneToOne
  @MapsId
  @JsonBackReference
  @JoinColumn(name = "shelterHomeCaseId")
  private ShelterHomeCase shelterHomeCase;
  ...
  public void copyTipData(ShelterHomeTip nDetails) {
